...
} libkparser_kref_io_thelimitbreaker_ExpressionParser;
      ...
      struct {
        struct {
          struct {
            ...
            libkparser_kref_io_thelimitbreaker_ExpressionParser (*ExpressionParser)();
            libkparser_KDouble (*evaluateExpression)(libkparser_kref_io_thelimitbreaker_ExpressionParser thiz, const char* expression, libkparser_KInt precision);
          } ExpressionParser;
        } thelimitbreaker;
      } io;
    } root;
